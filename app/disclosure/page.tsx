...
export const metadata: Metadata = {
  title: "Affiliate Disclosure — JuniperNode",
  description:
    "JuniperNode's affiliate disclosure policy. Learn how we may earn commissions through partner links on our site.",
};
    ...
    <div className="relative pt-32 pb-20 px-6">
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-6 text-white/60 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-white mb-3">Transparency First</h2>
            <p>
              JuniperNode is committed to transparency. This Affiliate Disclosure
          ...
          <section>
            ...
            <p>
              Some of the links on JuniperNode are affiliate links. This means that
            ...
            <p className="mt-3">
              ...
              research and hands-on testing required to provide accurate, up-to-date platform
              comparisons.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white mb-3">No Impact on Rankings</h2>
            <p>
              Our platform listings, ratings, and recommendations are never influenced by
              affiliate relationships. We evaluate platforms through hands-on testing and
              publicly available information — not sponsorship dollars.
              If a platform is featured on our site, it is because our team believes it provides
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Individual low-code and no-code platform referral programs</li>
              <li>PartnerStack</li>
              <li>Impact Radius</li>
            </ul>
            <p className="mt-3">
