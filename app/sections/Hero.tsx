    ...
    <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 px-6">
      <div className="max-w-[1200px] mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          <span className="text-sm font-medium text-[#F97316]">5000+ No-Code & Low-Code Tools Curated</span>
        </motion.div>
        ...
        >
          Find the Perfect No-Code Tool to{' '}
          <span className="text-gradient" style={{ textShadow: '0 0 40px rgba(234,88,12,0.3)' }}>
            Build Without Code
          </span>
        </motion.h1>
        ...
        >
          Compare 500+ no-code and low-code tools. Read verified reviews, analyze pricing, and find the right solutions.
        </motion.p>
