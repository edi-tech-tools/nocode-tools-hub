...
export const metadata: Metadata = {
  title: "Blog — NoCode Tools Hub",
  description:
    "Expert insights, comparisons, and strategies for choosing and using no-code and low-code tools. Stay informed with the latest in nocode and technology.",
};
