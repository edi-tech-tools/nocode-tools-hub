...
export const metadata: Metadata = {
  title: "Terms of Service — NoCode Tools Hub",
  description:
    "Read the Terms of Service for NoCode Tools Hub. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#8BA3BE] leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using the NoCode Tools Hub website (the "Site"), you agree to be
          ...
          <section>
            ...
            <p>
              NoCode Tools Hub is a curated directory platform that provides information,
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content — are owned by NoCode Tools Hub and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of NoCode Tools Hub. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              ...
              controlled by NoCode Tools Hub. We have no control over, and assume no
          ...
          <section>
            ...
            <p>
              NoCode Tools Hub offers free access to our directory and comparison features.
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, NoCode Tools Hub, its officers, directors,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless NoCode Tools Hub and its
