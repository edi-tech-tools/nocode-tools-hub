...
export const metadata: Metadata = {
  title: "Privacy Policy — NoCode Tools Hub",
  description:
    "Learn how NoCode Tools Hub collects, uses, and protects your personal data. Our privacy policy outlines our commitment to your privacy and data security.",
};
