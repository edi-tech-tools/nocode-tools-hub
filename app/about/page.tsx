...
export const metadata: Metadata = {
  title: "About — NoCode Tools Hub",
  description:
    "NoCode Tools Hub is an independent directory of no-code and low-code tools. We curate and compare nocode platforms to help makers build without coding.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#8BA3BE] leading-relaxed max-w-2xl mx-auto">
            NoCode Tools Hub is an independent directory that helps businesses
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4 text-[#8BA3BE] leading-relaxed">
            <p>
              NoCode Tools Hub was created to solve a common problem: finding
            ...
            <p>
              We catalog and compare A SaaS tools across 15+ categories,
